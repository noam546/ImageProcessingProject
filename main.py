...
if __name__ == '__main__':
    ...
    # ap.add_argument("-i", "--image", required=True, help="lena256.jpg")
    # ap.add_argument("-v", "--verbose", type=bool, default=False, help="lena256.jpg")
    # args = vars(ap.parse_args())

    image = cv2.imread("lena256.jpg",0)

    blurred_image = gaussian_blur(image, kernel_size=9, verbose=True)
